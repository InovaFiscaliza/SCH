classdef (Abstract) Constants
    ...
    properties (Constant)
        ...
        report_TableColumnNames   = {'Homologação', 'Importador', 'Código aduaneiro', 'Tipo', 'Fabricante', 'Modelo', 'RF?', 'Em uso?', 'Interferência?', 'Valor Unit. (R$)', ...
                                     'Qtd. uso/vendida', 'Qtd. estoque/aduana', 'Qtd. lacradas', 'Qtd. apreendidas', 'Qtd. retidas (RFB)'}
        report_TableColumnWidths  = {110, 'auto', 110, 300, 'auto', 150, 'auto', 'auto', 'auto', 110, 110, 110, 110, 110, 110}
    ...
    methods (Static = true)
        ...
        function d = listOfProductsColumnNames()
            ...
            values = [ "Usa radiofrequência?", ...
                       ...
                       "Qtd. unidades em estoque/aduana", ...
