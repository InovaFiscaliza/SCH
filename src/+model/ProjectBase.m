classdef (Abstract) ProjectBase
    ...
    %---------------------------------------------------------------------%
        ...
        WARNING_ENTRYEXIST = struct( ...
            ...
            'PRODUCTS', [ ...
                'Na lista de produtos inspecionados já consta um produto não ' ...
        ...
        WARNING_VALIDATIONSRULES = struct( ...
            ...
            'PRODUCTS', struct( ...
                ...
                'entity', [ ...
                    ...
                    'Por fim, em relação aos <b>PRODUTOS INSPECIONADOS</b>:<br>' ...
            ...
            'CUSTOMS', struct( ...
                'customsShipments', [ ...
                    'A destinação final deve ser definida para todos os registros, ' ...
                    'ou seja, não pode ser "-" ou "Vistoria".<br><br>' ...
                    'A indicação de uma <b>nota do auditor</b> é obrigatória nos seguintes casos:<br>' ...
                    '•&thinsp;Quando o registro tiver sido selecionado no processo de amostragem para ser vistoriado.<br>' ...
                    '•&thinsp;Quando o registro tiver sido vistoriado.<br>' ...
                    '•&thinsp;Quando a destinação final for "Perdimento".' ...
                ], ...
                'entity', [ ...
                    '____________<br>' ...
                    'Em relação à <b>ATIVIDADE DE INSPEÇÃO</b>:<br>' ...
                    '•&thinsp;O número deve ser válido (inteiro, positivo e finito).<br><br>' ...
                    'Em relação às <b>REMESSAS</b>, a decisão final deve ser definida para todos os registros, ' ...
                    'não podendo estar, quando do relato, na situação "-" ou "Vistoria".<br><br>' ...
                    'Além disso, a indicação de uma <b>nota do auditor</b> é obrigatória nos seguintes casos:<br>' ...
                    '•&thinsp;Quando o registro tiver sido selecionado no processo de amostragem para ser vistoriado.<br>' ...
                    '•&thinsp;Quando o registro tiver sido vistoriado.<br>' ...
                    '•&thinsp;Quando a destinação final for "Perdimento".' ...
                ] ...
