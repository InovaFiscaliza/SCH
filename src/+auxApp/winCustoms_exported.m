                ...
                case 1
                    ...
                    try
                        sendEventToHTMLSource(app.jsBackDoor, 'initializeComponents', { ...
                            ...
                            struct('appName', appName, 'dataTag', app.AnalysisDetails.UserData.id, 'tooltip', struct('defaultPosition', 'top', 'textContent', 'Abre formulário para edição de lista de produtos sob análise')), ...
