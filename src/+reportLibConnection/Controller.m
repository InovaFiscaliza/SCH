    ...
    methods (Static)
        ...
        function Run(mainApp, callingApp, context)
            arguments
                mainApp
                callingApp
                context {mustBeMember(context, {'PRODUCTS', 'CUSTOMS'})} = 'PRODUCTS'
            end
            ...
            reportInfo = struct('App',      mainApp, ...
                                ...
                                'Function', struct(...
                                                   ...
                                                   'var_CustomsShipmentsTotal',         'reportLibConnection.Variable.CustomsShipments(reportInfo, "Total")', ...
                                                   'var_CustomsShipmentsSummarySimple', 'reportLibConnection.Variable.CustomsShipments(reportInfo, "SummarySimple")', ...
                                                   'var_CustomsShipmentsSummaryFluid',  'reportLibConnection.Variable.CustomsShipments(reportInfo, "SummaryFluid")', ...
                                                   'tableCustomsShipments',             'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings)', ...
                                                   'tableCustomsShipments_Vistoria',    'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings, "Vistoria")', ...
                                                   'tableCustomsShipments_Perdimento',  'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings, "Perdimento")', ...
                                                   'tableCustomsShipments_Devolucao',   'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings, "Devolução")', ...
                                                   'tableCustomsShipments_Prazo',       'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings, "Prazo")', ...
                                                   'tableCustomsShipments_Liberado',    'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings, "Liberado")', ...
                                                   'tableCustomsShipmentsSummarized',   'reportLibConnection.Table.CustomsShipments(analyzedData.InfoSet.Products, tableSettings, "any", true)'), ...
                                'Project',  projectData, ...
                                'Context',  context,     ...
                                'Object',   [],          ...
